    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/DuplicateLineRemover"
            element={<DuplicateLineRemover />}
          />
          <Route
            path="/ItalicTextConverter"
            element={<ItalicTextConverter />}
          />
          <Route path="/PlainTextConverter" element={<PlainTextConverter />} />
          <Route path="/RemoveLineBreaks" element={<RemoveLineBreaks />} />
          <Route
            path="/ReverseTextGenerator"
            element={<ReverseTextGenerator />}
          />
          <Route
            path="/SentenceCaseConverter"
            element={<SentenceCaseConverter />}
          />
          <Route path="/SmallTextGenerator" element={<SmallTextGenerator />} />
          <Route
            path="/StackedTextGenerator"
            element={<StackedTextGenerator />}
          />
          <Route
            path="/StrikethroughTextGenerator"
            element={<StrikethroughTextGenerator />}
          />
          <Route
            path="/SuperscriptGenerator"
            element={<SuperscriptGenerator />}
          />
          <Route path="/TitleCaseConverter" element={<TitleCaseConverter />} />
          <Route
            path="/UnderlineTextGenerator"
            element={<UnderlineTextGenerator />}
          />
          <Route
            path="/UnicodeTextConverter"
            element={<UnicodeTextConverter />}
          />
          <Route path="/WhitespaceRemover" element={<WhitespaceRemover />} />
          <Route path="/WideTextGenerator" element={<WideTextGenerator />} />

          <Route
            path="/BinaryCodeTranslator"
            element={<BinaryCodeTranslator />}
          />
          <Route path="/CSVtoJSONConverter" element={<CSVtoJSONConverter />} />
          <Route path="/HextoTextConverter" element={<HextoTextConverter />} />
          <Route
            path="/JSONStringifyTextGenerator"
            element={<JSONStringifyTextGenerator />}
          />
          <Route
            path="/UTMBuilderGenerator"
            element={<UTMBuilderGenerator />}
          />
          ...
          <Route
            path="/OnlineSentenceCounter"
            element={<OnlineSentenceCounter />}
          />
          <Route
            path="/RepeatTextGenerator"
            element={<RepeatTextGenerator />}
          />
          <Route
            path="/RomanNumeralDateConverter"
            element={<RomanNumeralDateConverter />}
          />
          <Route
            path="/SortWordsAlphabetically"
            element={<SortWordsAlphabetically />}
          />
          <Route
            path="/TextReplacementTool"
            element={<TextReplacementTool />}
          />

          <Route
            path="/RandomChoiceGenerator"
            element={<RandomChoiceGenerator />}
          />
          <Route
            path="/RandomDateGenerator"
            element={<RandomDateGenerator />}
          />
          <Route
            path="/RandomIPAddressGenerator"
            element={<RandomIPAddressGenerator />}
          />
          <Route
            path="/RandomLetterGenerator"
            element={<RandomLetterGenerator />}
          />
          <Route
            path="/RandomMonthGenerator"
            element={<RandomMonthGenerator />}
          />
          <Route
          ...
          <Route
            ...
            element={<StrongPasswordGenerator />}
          />
        </Routes>
      </div>
    </Router>
